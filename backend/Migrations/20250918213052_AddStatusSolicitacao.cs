...
namespace backend.Migrations
{
    ...
    public partial class AddStatusSolicitacao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataOcorrencia = table.Column<DateTime>(
                    ...
                    Observacoes = table.Column<string>(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Solicitação aguardando análise do gestor.", "Pendente" },
                    {
                        2,
                        "Devolvida ao solicitante para correção ou mais informações.",
                        "Aguardando Ajustes",
                    },
                    {
                        3,
                    ...
                    {
                        6,
                        "Estado de arquivamento para solicitações de ciclos anteriores.",
                        "Encerrada",
                    },
                }
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "HistoricoSolicitacoes");

            migrationBuilder.DropTable(name: "StatusSolicitacoes");

            migrationBuilder.DropIndex(name: "IX_Solicitacoes_StatusId", table: "Solicitacoes");

            migrationBuilder.DropColumn(name: "StatusId", table: "Solicitacoes");
        }
    }
}
