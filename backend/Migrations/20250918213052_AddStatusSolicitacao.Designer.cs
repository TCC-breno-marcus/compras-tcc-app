...
namespace backend.Migrations
{
    ...
    [Migration("20250918213052_AddStatusSolicitacao")]
    partial class AddStatusSolicitacao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ComprasTccApp.Models.Entities.Historicos.HistoricoSolicitacao", b =>
                {
                    ...
                    b.HasOne("ComprasTccApp.Models.Entities.Status.StatusSolicitacao", "StatusAnterior")
                        .WithMany()
                        .HasForeignKey("StatusAnteriorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ComprasTccApp.Models.Entities.Status.StatusSolicitacao", "StatusNovo")
                        .WithMany()
